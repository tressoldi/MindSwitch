...
#This Software must be installed in the Raspberry microcontroller
...
#Extract the Variables from "MindSwitchParameters.txt"
pm = open('MindSwitchParameters.txt', 'r')
...
#Cut-off value for the Frequency Monobit Test
cutofffr = float(pm.readline())

pm.readline()

#Cut-off value for the Runs Test
cutoffru = float(pm.readline())
