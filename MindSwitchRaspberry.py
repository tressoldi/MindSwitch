...
# Created by luca.semenzato@unipd.it
...
def runstestoriginal(binin):

    print('==================================================')
    print('== Runs Test (original) ==========================')
    print('==================================================')
    ss = [int(el) for el in binin]
    len_binin = len(binin)
    pi = 1.0 * reduce(su, ss) / len_binin
...
def monobitfrequencytestoriginal(binin):
    print('==================================================')
    print('== Monobit Frequency Test (original) =============')
    print('==================================================')
    ss = [int(el) for el in binin]
    sc = map(sum_i, ss)
    sn = reduce(su, sc)
...
while count < C:
    ...
    if measure2 - measure1 >= count * int_time:
